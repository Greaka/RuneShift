...
namespace RuneShift.Code.GameStates.Ingame
{
    class Map
    {
        ...
        public Map()
        {
            ...
            StoneCircles.Add(new StoneCircle(rand, innerRadius,                       3, RotationDirection.Clockwise, AssetManager.getTexture(AssetManager.TextureName.Circle0_Innermost)));
            StoneCircles.Add(new StoneCircle(rand, innerRadius + circleDistance,      6, RotationDirection.CounterClockwise, AssetManager.getTexture(AssetManager.TextureName.Circle1)));
            StoneCircles.Add(new StoneCircle(rand, innerRadius + circleDistance * 2F, 7, RotationDirection.Clockwise, AssetManager.getTexture(AssetManager.TextureName.Circle2)));
            StoneCircles.Add(new StoneCircle(rand, innerRadius + circleDistance * 3F, 9, RotationDirection.CounterClockwise, AssetManager.getTexture(AssetManager.TextureName.Circle3)));
